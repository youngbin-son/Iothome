...
#define SERVER_NAME "10.10.52.198"
#define SERVER_PORT 5000
#define LOGID "SGC_WIFI"
...
void socketEvent()
{
  ...
  // client.write("[SGC_BT]LED@ON\n", strlen([SGC_BT]LED@ON\n));
  // client.flush();

  // client.write("[SGC_SQL]SET@LAMP@1\n", strlen([SGC_BT]LED@ON\n));
  // client.flush();
